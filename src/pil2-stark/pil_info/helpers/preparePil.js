...
module.exports.preparePil = function preparePil(pil, starkStruct, pil2, options = {}) {
    const res = {};
    ...
    if(pil2) {
        ...
        ({expressions, symbols, hints, constraints} = generatePil1Polynomials(res, pil, options));   
    }
