...
extern "C" void FrG_rawFrGomMontgomery(FrGRawElement pRawResult, const FrGRawElement &pRawA);
...
public:
    ...
    void inline fromMontgomery(Element &r, const Element &a) { FrG_rawFrGomMontgomery(r.v, a.v); };
