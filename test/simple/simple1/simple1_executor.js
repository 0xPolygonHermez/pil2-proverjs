...
class ExecutorSimple1 extends WitnessCalculatorComponent {
    constructor(wcManager, proofSharedMemory) {
        super("Simple1Ex", wcManager, proofSharedMemory);
    }
    ...
    async witnessComputation(stageId, subproofCtx, airId, instanceId) {
        ...
        for (let i = 0; i < N; i++) {
            ...
            subproofCtx.proofCtx.instances[0].wtnsPols.Simple1.a[i] = v;
            subproofCtx.proofCtx.instances[0].wtnsPols.Simple1.b[i] = F.square(v);
        }
